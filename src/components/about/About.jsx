        ...
        <div className="about__content">
          <div className="about__cards">
            ...
            <article className="about__card">
              ...
              <h5>Education</h5>
              <small>
                B.Sc. Coputer Science and Information Technology
                <br />
                {/*M.Sc. Innovation &
                Entrepreneurship*/}
              </small>
          ...
          <p>
            I'm a frontend developer currently working on the GUI of EMR, a
            large scale Medical Information Management system. My primary tech stack is Nextjs 14, Material Design, TypeScript, Node, and SCSS / SASS for styling. Git is used for team collaboration and Vercel for deployment.
